...
declare_id!("EcooiHrTiMnfUBMw297gvPwX55HD8SCxA61tBBLV3yaV");
...
pub mod portal {
    ...
    pub fn fund<'info>(ctx: Context<'info, Fund<'info>>, args: FundArgs) -> Result<()> {
    ...
    pub fn fulfill<'info>(ctx: Context<'info, Fulfill<'info>>, args: FulfillArgs) -> Result<()> {
